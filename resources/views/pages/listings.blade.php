							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
									<div class="property-listing property-1">
										...
										<div class="listing-content">
											...
											<div class="listing-detail-wrapper">
												<div class="listing-short-detail">
													<h4 class="listing-name"><a href="single-property-2.html">Apartment to rent in Queens</a></h4>
											...
											<div class="listing-features-info">
												<ul>
													<li><strong>Bed:</strong>3</li>
													<li><strong>Bath:</strong>2</li>
													<li><strong>Sqft:</strong>2,800</li>
												</ul>
											</div>
										
											<div class="listing-footer-wrapper">
												<div class="listing-price">
													<h4 class="list-pr">$122,580</h4>
												</div>
												<div class="listing-detail-btn">
													<a href="single-property-2.html" class="more-btn">More Info</a>
												</div>
								...
								<div class="col-lg-12 col-md-12">
									<div class="property-listing property-1">
										...
										<div class="listing-img-wrapper">
											<a href="single-property-2.html">
												<img src="assets/img/p-7.jpg" class="img-fluid mx-auto" alt="" />
											</a>
											<div class="listing-like-top">
												<i class="ti-heart"></i>
											</div>
										...
										<div class="listing-content">
											...
											<div class="listing-detail-wrapper">
												<div class="listing-short-detail">
													<h4 class="listing-name"><a href="single-property-2.html">Beautiful Flat in Manhattan</a></h4>
													<span class="listing-location"><i class="ti-location-pin"></i>4755 Irish Lane, Madison</span>
												</div>
												<div class="list-author">
													<a href="#"><img src="assets/img/add-user.png" class="img-fluid img-circle avater-30" alt=""></a>
												</div>
											...
											<div class="listing-features-info">
												<ul>
													<li><strong>Bed:</strong>2</li>
													<li><strong>Bath:</strong>2</li>
													<li><strong>Sqft:</strong>2,970</li>
												</ul>
											</div>
