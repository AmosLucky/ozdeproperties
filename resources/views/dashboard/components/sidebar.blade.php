    ...
    <div class="dashboard-navbar">
        ...
        <div class="d-navigation">
            <ul>
                ...
                <li><a href="bookmark-list.html">
                    <i class="ti-bookmark"></i>Bookmarked Listings</a></li>
                <li><a href="my-property.html">
                    <i class="ti-layers"></i>My Properties</a></li>
                <li><a href="add_property">
                    <i class="ti-pencil-alt"></i>Submit New Property</a></li>
